...
import { none, pierce3, poison, muddle, invisible } from './effects';
...
export const rollingPierce3SC = { modifier: '+0', effect: pierce3, rolling: true, source: 'sc', img: RollingPierce3 };
