...
import { none, wound, stun, fire, disarm, heal } from './effects';
...
export const rollingHeal1SelfBE = { modifier: '+0', effect: heal, rolling: true, source: 'be', img: RollingHeal1Self };
