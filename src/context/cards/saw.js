...
import { none, immobilize, wound, heal, stun, refreshItem  } from './effects';
...
export const rollingHeal3SelfSB = { modifier: '+0', effect: heal, rolling: true, source: 'sb', img: RollingHeal3Self };
